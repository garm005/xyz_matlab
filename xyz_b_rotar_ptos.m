function xyz_rotar_ptos(x,y,z,beta,x_ori,y_ori,nexport,flagexpo)
...
%
% Ejemplos:
% xyz_rotar_ptos(bati(:,1),bati(:,2),bati(:,3),60,535678,2345678,'batirot',1);
% xyz_rotar_ptos(bati(:,1),bati(:,2),bati(:,3),60,min(bati(:,1)),min(bati(:,2),'batirot',3);
%
% Notas:
